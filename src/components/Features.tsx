...
const features = [
  ...
  },
  {
    ...
    description: "Ask questions in English, Spanish, Mandarin or Hindi. Get responses in your preferred language for better comprehension."
  },
  {
    icon: Brain,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            No more rewinding, no more confusion—get the clarity you need, the moment you need it.
          </p>
        </div>
